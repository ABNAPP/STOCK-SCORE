...
export default function Header({ onMenuToggle, isMenuOpen, onNavigate, onOpenAdminPanel, onOpenUserProfile }: HeaderProps) {
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        {currentUser && isAdmin && onOpenAdminPanel && (
          <button
            ...
            className="px-3 sm:px-4 py-2.5 sm:py-2 bg-purple-600 text-white text-sm font-semibold rounded-lg hover:bg-purple-700 active:bg-purple-800 transition-all duration-200 flex items-center space-x-2 shadow-sm hover:shadow-md active:scale-95 min-h-[44px] touch-manipulation"
            title={t('admin.panel')}
          >
            <svg
              className="w-4 h-4 sm:w-5 sm:h-5"
